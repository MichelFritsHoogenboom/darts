...
<template>
  <div class="player-card inactive rounded-lg p-8">
    <!-- Game Type Selection -->
    <div class="mb-6">
    ...
    <div class="flex gap-4 items-stretch">
      <div class="flex-1">
        <FormSelect
          v-model="config.gamePlayedIn"
          :options="gamePlayedInOptions"
        >
      ...
      <div
        class="flex-1"
        v-if="config.gamePlayedIn === X01_GAME_PLAYED_IN.sets"
      >
        <FormSelect
          v-model="config.legsToWinParent"
          :options="legsToWinSetOptions"
        >
          <template #label>Legs to Win Set</template>
        </FormSelect>
      </div>
    </div>
    ...
    <div class="flex gap-4 items-stretch mb-6">
      ...
      <!-- Legs to Win Parent -->
      <div
        v-if="config.gamePlayedIn === X01_GAME_PLAYED_IN.legs"
        class="flex-1"
      >
        <FormSelect
          v-model="config.legsToWinParent"
